        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200" style="padding-top: 20px">
				...
				<li class="nav-item ">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="icon-basket-loaded"></i>
                        <span class="title">word管理</span>
						<span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
						<li class="nav-item ">
                            <a id="wordListMenu" href="<%=request.getContextPath() %>/word/showWordList.action" class="ajaxify nav-link " id="wordListMenu">
                                <span class="title">word列表</span>
                            </a>
                        </li>
                        <%-- <li class="nav-item ">
                            <a href="<%=request.getContextPath() %>/word/showAddWord.action" class="ajaxify nav-link ">
                                <span class="title">添加word</span>
                            </a>
                        </li> --%>
                    </ul>
               	</li>
