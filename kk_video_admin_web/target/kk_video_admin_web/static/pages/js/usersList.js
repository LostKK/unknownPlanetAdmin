	...
	var handleList = function() {
        ...
        jqGrid.jqGrid({  
            ...
            colModel: [  
                ...
                { name: 'faceImage',  width: 50, sortable: false,
                ...
                { name: 'username',  width: 30, sortable: false },
                { name: 'nickname',  width: 30, sortable: false },
                { name: 'fansCounts',  width: 20, sortable: false },
                { name: 'followCounts', width: 20, sortable: false },
                { name: 'receiveLikeCounts',  width: 20, sortable: false, hidden: false }
            ],  
